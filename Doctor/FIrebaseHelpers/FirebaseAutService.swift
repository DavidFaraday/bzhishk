        ...
        Auth.auth().createUser(withEmail: email, password: password, completion: { (authDataResult, error) in
            ...
            if error == nil {
                ...
                if authDataResult?.user != nil {
                    let user = User(id: authDataResult!.user.uid, name: email, email: email, pushId: "", avatarLink: "", address: "", telephone: "", mobilePhone: "", isOnboardingCompleted: false, userType: UserType.Doctor.rawValue, isOnline: false)
